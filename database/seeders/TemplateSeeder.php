...
class TemplateSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $templates = [
            ...
            // ── Art Deco Gatsby (Premium) ─────────────────────────
            [
                'category_id'    => $pernikahan->id,
                'name'           => 'Art Deco Gatsby',
                'slug'           => 'art-deco-gatsby',
                'thumbnail_url'  => '/images/templates/art-deco-gatsby/thumbnail.webp',
                'description'    => 'Template pernikahan premium Art Deco era Gatsby — geometric gold starburst, champagne tower, fanfare brass band animation. Glamour 1920an untuk pasangan yang ingin kesan "the great wedding party."',
                'default_config' => [
                    'primary_color'        => '#c9a84c',
                    'primary_color_light'  => '#f0d080',
                    'secondary_color'      => '#1a1410',
                    'accent_color'         => '#8b6914',
                    'dark_bg'              => '#0d0b08',
                    'bg_color'             => '#0d0b08',
                    'text_color'           => '#f5e6c8',
                    'text_secondary'       => '#c9a84c',
                    'font_title'           => 'Cinzel Decorative',
                    'font_heading'         => 'Cormorant Garamond',
                    ...
                    'opening_style'        => 'fade',
                    'section_backgrounds'  => [],
                    'adg_starburst_density' => 'medium',
                    'adg_champagne_enabled' => true,
                    'adg_fanfare_enabled'   => true,
                    'adg_monogram'          => 'A & B',
                ],
                'demo_data'      => array_merge($weddingDemo, ['custom_config' => [
                    'adg_starburst_density' => 'medium',
            ...
            // ── Belle Epoque Parisian (Premium) ───────────────────
            [
                'category_id'    => $pernikahan->id,
                'name'           => 'Belle Époque Parisian',
                'slug'           => 'belle-epoque',
                'thumbnail_url'  => '/images/templates/belle-epoque/thumbnail.webp',
                'description'    => 'Template pernikahan premium bergaya Paris Belle Époque — Eiffel Tower silhouette, Art Nouveau floral borders, watercolor washes. Untuk pasangan yang bermimpi menikah di Paris.',
                'default_config' => [
                    'primary_color'        => '#8b4569',
                    'primary_color_light'  => '#d4a0bc',
                    'secondary_color'      => '#2c3e50',
                    'accent_color'         => '#c9a84c',
                    'dark_bg'              => '#1a1520',
                    'bg_color'             => '#fdf8f2',
                    'text_color'           => '#2c2028',
                    'text_secondary'       => '#6b5060',
                    'font_title'           => 'Cormorant Garamond',
                    ...
                    'opening_style'        => 'gate',
                    'section_backgrounds'  => [],
                    'be_eiffel_visible'    => true,
                    'be_floral_intensity'  => 'medium',
                    'be_language'          => 'french-mix',
                ],
                'demo_data'      => array_merge($weddingDemo, ['custom_config' => [
                    'be_eiffel_visible'   => true,
                    'be_floral_intensity' => 'medium',
            ...
            // ── Velvet Burgundy (Premium) ─────────────────────────
            [
                'category_id'    => $pernikahan->id,
                'name'           => 'Velvet Burgundy',
                'slug'           => 'velvet-burgundy',
                'thumbnail_url'  => '/images/templates/velvet-burgundy/thumbnail.webp',
                'description'    => 'Template pernikahan premium bergaya velvet mewah — deep burgundy, gold embossed monogram, candle warm lighting. Untuk pasangan yang menginginkan kesan dramatis dan romantis.',
                'default_config' => [
                    'primary_color'        => '#800020',
                    'primary_color_light'  => '#c04060',
                    'secondary_color'      => '#2c1810',
                    'accent_color'         => '#c9a84c',
                    'dark_bg'              => '#1a0a10',
                    'bg_color'             => '#1a0a10',
                    'text_color'           => '#f5e6d8',
                    'text_secondary'       => '#c9a07a',
                    'font_title'           => 'Cormorant Garamond',
                    'font_heading'         => 'Playfair Display',
                    'font_body'            => 'EB Garamond',
                    'gallery_layout'       => 'masonry',
