        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
                ...
                <div class="p-4">
                    ...
                    <!-- Actions — primary fill, secondary/destructive as compact icons -->
                    <div class="flex items-center gap-2">
                        ...
                        <button
                            ...
                            class="shrink-0 p-2 rounded-xl border border-stone-200 text-stone-500 hover:bg-stone-50 hover:text-stone-700 transition-colors"
                        ...
                        <button
                            ...
                            class="shrink-0 p-2 rounded-xl border border-red-100 text-red-400 hover:bg-red-50 hover:text-red-600 transition-colors"
